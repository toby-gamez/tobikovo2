document.addEventListener('DOMContentLoaded', function () {
    ...
    <div class="mobile-menu">
        <ul class="nav flex-column">
            ...
            <div class="version-info">25w08a</div>
    ...
    function initDarkMode() {
        ...
        function enableDarkMode() {
            ...
            document.querySelectorAll('footer, p, h2, ul, li, .grid-item, .search-snippet, .key-icon, button, #MyNavBar, .modal-content, #results, #results div, .scrollable-menu, .nav-text, .underlined, .version-info, #search, table, th, td, textarea, .opinion-input, .nav-link, h3, h4, img, video, hr, a, .button-container, .button-container a, .footer-content, .navImg, .Mcard, .Minfo, .Mnadpis, .mobile-header, .loading-bar, .mobile-menu').forEach(element => {
        ...
        function disableDarkMode() {
            ...
            document.querySelectorAll('footer, p, h2, ul, li, .grid-item, .search-snippet, .key-icon, button, #MyNavBar, .modal-content, #results, #results div, .scrollable-menu, .nav-text, .underlined, .version-info, #search, textarea, .opinion-input, .nav-link, th, td, h3, h4, hr, a, img, video, .button-container, .button-container a, .footer-content, .navImg, .Mcard, .Minfo, .Mnadpis, .mobile-header, .loading-bar, .mobile-menu').forEach(element => {
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    window.addEventListener("keydown", function (event) {
        ...
        const isTyping = activeElement === 'input' ||
